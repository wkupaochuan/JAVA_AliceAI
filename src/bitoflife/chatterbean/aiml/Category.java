...
public class Category implements AIMLElement {
	...
	public Category(String pattern, Object... children) {
		this(new Pattern(pattern), new That("*"), new Topic("*"), new Template(
				children));
	}
	...
	public void appendChild(AIMLElement child) {
		if (child instanceof Pattern) {
			...
			throw new ClassCastException("Invalid element of type "
	...
	public boolean equals(Object obj) {
		...
		return (pattern.equals(compared.pattern)
				&& template.equals(compared.template) && that
				.equals(compared.that));
	}
	...
	public String[] getMatchPath() {
		...
		java.lang.System.arraycopy(pattPath, 0, matchPath, 0, m);
		java.lang.System.arraycopy(thatPath, 0, matchPath, m + 1, n);
		java.lang.System.arraycopy(topicPath, 0, matchPath, m + 1 + n + 1, o);
		return matchPath;
	}
	...
	public String toString() {
		return "[" + pattern.toString() + "][" + that.toString() + "]["
				+ template.toString() + "]";
	}
}
