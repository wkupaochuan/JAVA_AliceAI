/*
 * Copyleft (C) 2005 H閘io Perroni Filho xperroni@yahoo.com ICQ: 2490863 This
...
public class Transformations {
	...
	// 规则只允许字母，数字和中文
	// private final Pattern fitting = Pattern
	// .compile("[^A-Z0-9\u4E00-\u9FA5]+");
	private final Pattern fitting = Pattern
			.compile("[^A-Z0-9\u4E00-\u9FA5\\+]+");
	...
	public void normalization(Request request) {
		...
		for (int i = 0, n = input.length; i < n; i++) {
			...
			// 20140306新增保存获取star值
			sentences[i].setStarValue(request.getStarValue());
